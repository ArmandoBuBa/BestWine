...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
      ...
      <?php
                ...
                $txtImg = isset($_POST['txtImg']) ? $_POST['txtImg'] : '';
                 ...
                 <script>
                    setTimeout(function(){
                        alert("haz agotado el tiempo de compra intentalo de nuevo")
                 ...
                 <div class="u-repeater u-repeater-2">
                   <div class="u-container-style u-custom-item u-hover-feature u-list-item u-repeater-item u-shape-rectangle u-white u-list-item-7" data-animation-out="0">
                     <div class="u-container-layout u-similar-container u-container-layout-8">
                       <img alt="" class="infinite u-bottom-left-radius-20 u-expanded-width u-image u-image-round u-top-right-radius-20 u-image-7" data-image-width="960" data-image-height="960" src="images/'.$txtImg.'.jpeg" data-animation-name="pulse" data-animation-duration="1000" data-animation-direction="">
                       <h3 class="u-text u-text-default u-text-2">'.$txtCompra.'</h3>
                       <br>
                       <br>
                       <br>
                       <br>
                       </p>
                       <p class="u-align-justify u-text u-text-4">Total a Pagar: $'.$txtPrecio.'</p>
                       <br>
                       <br>
                       <p class="u-align-justify u-text u-text-4"> Cantidad :'.$txtCantidad.'</p>
                     </div>
                   </div> 
                 </div>
